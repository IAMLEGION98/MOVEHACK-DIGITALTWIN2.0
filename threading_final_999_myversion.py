...
def f1():
    ...
    while True:
        ...
        if(i%100==0):
            ...
            #TS1 = urllib.request.urlopen("https://api.thingspeak.com/update?api_key=EGB3IM8MPQH4U8VK&field6="+str(SPEED)+"&field3="+str(2*SND))
            #result1=fr.put('/','BlinkRate',str(SND))
...
def f2():
    ...
    while True:
        time.sleep(30)
        #result1=fr.post('/a124-270e9',{'Blinkrate':str(SND)})
        #result2=fr.post('/a124-270e9',{'Speed':str(SPEED)})
        ...
        #Vijey
        #TS1 = urllib.request.urlopen("https://api.thingspeak.com/update?api_key=T6OP72D3KX3HEF7U&field1="+str(TOTAL)+"&field2="+str(SPEED)+"&field3="+str(int((TOTAL-TOTAL1))))
        TS1.close()
        TOTAL1=TOTAL
def f3():
    time.sleep(37)
    ...
    CHANNEL_ID_1= '562330'
    #Vijey
    #READ_API_KEY_1='H21BESU6KE9LIXCZ'  
    #CHANNEL_ID_1= '562435'
    ...
    while True:
        ...
        if(a1>29 and p==0):
            #send_mail('vijaysrivaths@gmail.com','Warning!','Temperature of package compromised')
        ...
        if(max(h0,h1,h2)==h1 and p1==0):
            #send_mail('vijaysrivaths@gmail.com','Package condition\n','WARNING'+str(h0)+' '+str(h1)+' '+str(h2)+' ')
